...
@CreateTableSql("CREATE TABLE t_fanbox_artist(" + "id int primary key, " + "name text, " +
        "artist_id text, " + "gmt_create text, " + "last_update text, " + "enable BOOLEAN NOT " +
        "NULL CHECK (enable IN (0, 1))" + ");")
